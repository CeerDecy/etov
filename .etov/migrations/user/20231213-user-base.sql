...
INSERT INTO USERS (nickname, email, phone, password, avatar, api_key, salt, validate, created_at, updated_at,
                   deleted_at)
VALUES ('etov', 'etov@etov.com.cn', null, null, null, null, null, 'N', now(), now(),NULL);
