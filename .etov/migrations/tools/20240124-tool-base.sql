...
(
    ...
    `params`      VARCHAR(255)          DEFAULT '' COMMENT '工具链接',
...
INSERT INTO TOOL (name, logo, url, params, description, is_public, author_id, created_at, updated_at, deleted_at)
VALUES ('ChatGPT3.5',
...
INSERT INTO TOOL (name, logo, url, params, description, is_public, disabled, author_id, created_at, updated_at,
                  deleted_at)
VALUES ('ChatGPT4.0',
